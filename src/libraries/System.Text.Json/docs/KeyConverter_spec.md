...
* Supported types (Types supported by [`Utf8Formatter/Parser`](https://docs.microsoft.com/dotnet/api/system.buffers.text.utf8formatter?view=netcore-3.1) + a few others that are popular):
  * Boolean
  * Byte
  * DateTime
  * DateTimeOffset
