//------------------------------------------------------------------
// <copyright file="RecognizedPhrase.cs" company="Microsoft">
...
namespace System.Speech.Recognition
{
    ...
    public class RecognizedPhrase
    {
        ...
        public ReadOnlyCollection<RecognizedWordUnit> Words
        {
            get
            {
                if (_words == null)
                {
                    ...
                    List<RecognizedWordUnit> wordList = new List<RecognizedWordUnit> (countOfElements);
        ...
        public ReadOnlyCollection<RecognizedPhrase> Homophones
        {
            get
            {
                ...
                if (_homophones == null)
                {
                    ...
                    List<RecognizedPhrase> homophones = new List<RecognizedPhrase> (_recoResult.Alternates.Count);
                    for (int i = 0; i < _recoResult.Alternates.Count; i++)
                    {
        ...
        {
            List<ResultPropertiesRef> propertyList = new List<ResultPropertiesRef> ();
        ...
        static private void DumpAll (RuleNode ruleTree, IList<RecognizedWordUnit> words, SPSERIALIZEDPHRASE serializedPhrase, IntPtr phraseBuffer, bool isSapi53Header)
        {
            DumpWords (words);
        ...
        static private void DumpWords (IList<RecognizedWordUnit> words)
        {
            StringBuilder sb = new StringBuilder ();
