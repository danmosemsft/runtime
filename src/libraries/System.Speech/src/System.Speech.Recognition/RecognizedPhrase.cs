...
namespace System.Speech.Recognition
{
    ...
    public class RecognizedPhrase
    {
        ...
        /// <summary>Gets a value, assigned by the recognizer, that represents the likelihood that a <see cref="System.Speech.Recognition.RecognizedPhrase" /> matches a given input.</summary>
        ...
        /// <returns>The collection of <see cref="System.Speech.Recognition.RecognizedWordUnit" /> objects generated by a speech recognizer for recognized input.</returns>
        ...
        /// <summary>Gets the <see cref="System.Speech.Recognition.Grammar" /> that the speech recognizer used to return the <see cref="System.Speech.Recognition.RecognizedPhrase" />.</summary>
        ...
        /// <returns>A collection of <see cref="System.Speech.Recognition.ReplacementText" /> objects that describe sections of text that the speech recognizer replaced when it normalized the recognized input.</returns>
        ...
        /// <summary>Returns a semantic markup language (SML) document for the semantic information in the <see cref="System.Speech.Recognition.RecognizedPhrase" /> object.</summary>
        /// <returns>Returns an SML description of the semantics of the <see cref="System.Speech.Recognition.RecognizedPhrase" /> as an XPath navigable object.</returns>
        ...
        private static bool ExecuteOnParse(Grammar grammar, RuleNode ruleRef, SemanticValue value, IList<RecognizedWordUnit> words, out object newValue)
        {
            ...
            foreach (ScriptRef scriptRef in scripts)
            {
                ...
                {
                    newValue = grammar._proxy.OnParse(scriptRef._rule, scriptRef._sMethod, parameters, out Exception exceptionThrown);
                    if (exceptionThrown != null)
                    {
                        throw exceptionThrown;
                    }
                ...
                {
                    GetRuleInstance(grammar, scriptRef._rule, scriptRef._sMethod, out MethodInfo onParse, out Grammar ruleInstance);
        ...
        private static bool ExecuteOnError(Grammar grammar, RuleNode ruleRef, Exception e)
        {
            ...
            foreach (ScriptRef scriptRef in scripts)
            {
                ...
                if (grammar._proxy != null)
                {
                    grammar._proxy.OnError(scriptRef._rule, scriptRef._sMethod, parameters, out Exception exceptionThrown);
                    if (exceptionThrown != null)
                    {
                        throw exceptionThrown;
                    }
        ...
        private static object TryExecuteOnRecognition(Grammar grammar, RecognitionResult result, string rootRule)
        {
            ...
            if (grammar != null && grammar._scripts != null)
            {
                ...
                foreach (ScriptRef scriptRef in scripts)
                {
                    ...
                    if (grammar._proxy != null)
                    {
                        result2 = grammar._proxy.OnRecognition(scriptRef._sMethod, parameters, out Exception exceptionThrown);
                        if (exceptionThrown != null)
                        {
                            throw exceptionThrown;
                        }
